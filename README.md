...
舞台も、映画のように「スキマ時間に観劇」することは可能で、このアプリを窓口に市場を回復していきたいと考えます。
#### 他の検索サイトとの違い  
同じ検索機能を持ったチケットサイト(ローチケ・チケットぴあ等)では、何を見たいかが決まっている前提で、そのチケットを買うための検索になります。なのでこのStearch!は、ユーザーの「急に時間が空いてしまった」「近くの地域で何かやっていないか」「舞台について詳しくないけど希望の日程で何かやっていないか」などといった"緊急性優先"で調べることができるアプリになります。
